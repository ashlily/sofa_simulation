    ...
    def onBeginAnimationStep(self, deltaTime):
        ...
        try:
            ...
            if self.manipulation_flag >= 5:
               ...
               amp = 0.8
               self.mp1.findData('movements').value = [1, 1, 0.8]
               self.mp2.findData('movements').value = [1, 1, 0.8]
               self.mp3.findData('movements').value = [1, 1, 0.8]
               self.mp4.findData('movements').value = [1, 1, 0.8]
               self.mp5.findData('movements').value = [1, 1, 0.8]
               self.mp6.findData('movements').value = [1, 1, 0.8]
               self.mp7.findData('movements').value = [1, 1, 0.8]
               self.mp8.findData('movements').value = [1, 1, 0.8]
               self.mp9.findData('movements').value = [1, 1, 0.8]
               self.mp10.findData('movements').value = [1, 1, 0.8]
