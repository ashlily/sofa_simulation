    ...
    def onBeginAnimationStep(self, deltaTime):
        ...
        try:
            ...
            if self.data == 'Hello, world':
               ...
               if self.data == '041111':
                 print "You pressed record"
                 file = open("/home/ashily/sofa/v17.06/src/applications/plugins/SofaPython/examples/deformation_simulation/revise/test_record.txt","a")
                 file.write("You pressed record"+"\n")
                 file.close() 
                 self.record_flag = 2
                 cmd_f =[0 for i in range(3)]#need to change according to the manipulation_point number
               else:
