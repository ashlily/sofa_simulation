...
class TutorialForceFieldLiverFEM (Sofa.PythonScriptController):
    ...
    fp_index = [88, 92, 93, 94, 96, 97, 101, 104, 105, 110]
    manipulation_flag = 0
    ...
    def onBeginAnimationStep(self, deltaTime):
        ...
        try:
            ...
            if self.manipulation_flag >= 10:
               ...
               self.LiverFEM.getObject('PartialLinearMovementConstraint').findData('movements').value = [0.8*math.sin(cT), 0.8*math.cos(cT), 0.8*math.cos(cT)]
